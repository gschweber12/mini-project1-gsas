...
- Master Branch: the master branch in git is simply the default branch and as commits are made the master branch continues to point to the last commit made.
